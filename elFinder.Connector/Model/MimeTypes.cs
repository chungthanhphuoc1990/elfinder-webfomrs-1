...
namespace elFinder.Connector.Model
{
    public static class MimeTypes
    {
		...
		private const string UnknownMimeTypeReplace = "application/octet-stream";
        ...
        {
            var a = contentTypes.Single(p => p.Value == contentType);
			return a.Key;
        }
        /// <summary>
        ...
        public static string GetContentType(string fileName)
        {
			...
			if( string.IsNullOrWhiteSpace( contentType ) )
				contentType = UnknownMimeTypeReplace;
